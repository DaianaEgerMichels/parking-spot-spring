...
public class ParkingSpotModel implements Serializable {
    ...
    private String parkingSpotNumber; //vaga
    ...
    private LocalDateTime registrationDate; //data de registro do carro
    @Column(nullable = false, length= 130)
    private String responsibleName; //responsavel pelo carro
